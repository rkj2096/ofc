...
<?php
	...
	{   
		...
		$query = "INSERT INTO application( app_name, app_id, post, gs_link, dblp_link";
		$value = "VALUES ('{$app_name}','{$app_id}','{$app_post}','{$gs_link}','{$dblp_link}'";
	...
	<div class="form-group">
		...
		<div class="cols-sm-6">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="app_name" placeholder="" required/>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="cols-sm-6">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="app_id" placeholder="" required/>
			</div>
		</div>
	</div>
	<div class="form-group">
			...
			<div class="input-group">
				...
				<select name="app_post" class="form-control">
				  <option value="1">Assistant Professor</option>
				   <option value="2">Assistant Professor(On Contract)</option>
				  <option value="3">Visiting Professor</option>
				  <option value="4">DST Inspire Faculty</option>
				</select>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="cols-sm-6">
			<div class="input-group">
				...
				<input type="text" class="form-control" name="gs_link" placeholder=""/>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="cols-sm-6">
			<div class="input-group">
				<span class="input-group-addon"><i class="fa fa-external-link" aria-hidden="true"></i></span>
				<input type="text" class="form-control" name="db_link" placeholder=""/>
			</div>
		</div>
	</div>
	<div class="form-group">
